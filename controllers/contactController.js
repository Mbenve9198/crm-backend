...
export const getLeadFunnelAnalytics = async (req, res) => {
  try {
    ...
    const sourcesOfInterest = ['smartlead_outbound', 'inbound_rank_checker', 'inbound_acquisition', 'inbound_form', 'inbound_api', 'manual', 'csv_import', 'referral'];
    const pipeline = [
      {
        $match: {
...
export const getOwnerPerformanceAnalytics = async (req, res) => {
  try {
    ...
    const allSources = ['smartlead_outbound', 'inbound_rank_checker', 'inbound_acquisition', 'inbound_form', 'inbound_api', 'manual', 'csv_import', 'referral'];
