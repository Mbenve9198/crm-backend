...
> «Buongiorno, sono Alessandro [di Menu Chat / Menù Chat]. Guarda, vi chiamavo perché ho visto [il vostro ristorante/pizzeria] qui su Google Maps…»
...
**Chi:** Menu Chat / Menù Chat (stesso brand; nel corpus compaiono anche varianti fonetiche tipo «Menuciak», «Meno Chat»).
...
**Cosa NON è (dal corpus):** non è Google ufficiale (`6a7201d5` «chiama per conto di Google Maps?» → «No, Menù Chat»); non è gestione social; non è pubblicità generica.
